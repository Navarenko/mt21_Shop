...
<!--        ÄÎÑÒÀÂÊÀ ÍÀ 1 ØÀÃÅ    èç payment_method    -->

<script type="text/javascript">
$('input[name=\'shipping_method\']').on('change', function() {
	if ((this.value == 'shipping') || (this.value == 'transport')) {
...
<label><? echo $text_checkout_shipping_method; ?></label>
<div class="radio no_display">
    <label>
  ...
  <!-- Дата и время доставки -->
    <div id="block_time_date_shipping">
      <div class="block_date_shipping">
        <p>Дата доставки:</p>
        <input type="text" name="date_ship" id="input-date_ship" class="form-control">
        <!-- <script type="text/javascript">
          $(function () {
    ...
    <br>
      ...
      <div class="form-group">        
        ...
        <input type="text" name="city" value="<?php echo $cur_city; ?>" placeholder="<?php echo $entry_city; ?>" id="input-payment-city" class="form-control" />
	<br>
      <!-- <div class="form-group">
