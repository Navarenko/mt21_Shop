...
class ControllerAccountRegister extends Controller {
	...
	public function index() {
		...
		$data['entry_email_login'] = $this->language->get('entry_email_login');
		...
		/*if (isset($this->request->post['zone_id'])) {
			...
			$data['zone_id'] = '';
											...
											/*  _______________________MY TEST!!!!!!!!!!_____________________*/
	...
	private function validate() {
		...
		/* $this->load->model('localisation/country'); */											/*  _______________________MY TEST!!!!!!!!!!_____________________*/
