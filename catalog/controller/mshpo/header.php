<?php
class ControllerMshpoHeader extends Controller {
  public function index() {
    ...
    if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/mshpo/header.tpl')) {
      return $this->load->view($this->config->get('config_template') . '/template/mshpo/header.tpl', $data);
    } else {
      return $this->load->view('default/template/mshpo/header.tpl', $data);
    }
  }
}