...
class ControllerCommonFooter extends Controller {
	public function index() {
		...
		$data['text_complaint_form'] = $this->language->get('text_complaint_form');
		...
		$data['text_title_account'] = $this->language->get('text_title_account');
		$data['text_order'] = $this->language->get('text_order');
		$data['text_wishlist'] = $this->language->get('text_wishlist');
		$data['text_newsletter'] = $this->language->get('text_newsletter');

		$data['text_all_rights'] = $this->language->get('text_all_rights');
		$data['text_download_app'] = $this->language->get('text_download_app');
		$data['text_medtorg'] = $this->language->get('text_medtorg');
