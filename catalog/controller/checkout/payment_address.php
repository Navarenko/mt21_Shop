...
class ControllerCheckoutPaymentAddress extends Controller {
	public function index() {
		...
		$data['text_shipping'] = $this->language->get('text_shipping').get_list_cities(get_key_iferror(),1).'.';
		$data['text_pickup'] = $this->language->get('text_pickup').get_list_cities(get_key(),0).'.';
		...
		//$this->session->data['payment_address']['shipping_method'] = ""; // MY SHIPPING METHOD 
	}
		...
		if (!$json) {
			...
			if (isset($this->request->post['payment_address']) && $this->request->post['payment_address'] == 'existing') {
				...
				if (!$json) {
					...
					$temp = $this->request->post['shipping_method'];
					if ($temp == 'pickup') {
						$temp = 'Самовывоз';
