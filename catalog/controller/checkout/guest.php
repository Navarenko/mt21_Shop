...
class ControllerCheckoutGuest extends Controller {
	public function index() {
		...
		$data['text_shipping'] = $this->language->get('text_shipping').get_list_cities(0,1).'.';
		$data['text_pickup'] = $this->language->get('text_pickup').get_list_cities(0,0).'.';
		$data['text_transport'] = $this->language->get('text_transport');
		$data['text_choose_method_shipping'] = $this->language->get('text_choose_method_shipping');
		$data['text_checkout_shipping_method'] = $this->language->get('text_checkout_shipping_method');
		
		include $_SERVER['DOCUMENT_ROOT'].'/shop/identify-region.php';
		$data['cur_city'] = get_cur_city();																										/*        end mycode           */
		...
		if ($this->config->get($this->config->get('config_captcha') . '_status') && in_array('register', (array)$this->config->get('config_captcha_page'))) {
			...
			$data['captcha'] = '';
																										...
																										/* ______________ SHIPPING METHOD _________________ 
...
*/
	...
	public function save() {
		...
		if (!$json) {
			...
			$this->session->data['guest']['shipping_method'] = $this->request->post['shipping_method'];  // MY SHIPPING METHOD 
			...
			$this->session->data['payment_address']['method_ship'] =  $temp;
			$this->session->data['payment_address']['date_ship'] =  $this->request->post['date_ship'];	
			$this->session->data['payment_address']['time_ship'] =  $this->request->post['time_ship'];	
