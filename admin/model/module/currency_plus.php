<?php
class ModelModuleCurrencyPlus extends Model {
    public function addCurrency($data) {
        $this->db->query("INSERT INTO " . DB_PREFIX . "currency
        SET title = '" . $this->db->escape($data['title']) . "', code = '" . $this->db->escape($data['code']) . "',
        ...
        value_official = '" . $this->db->escape($data['value_official']) . "', status = '" . (int)$data['status'] . "', date_modified = NOW()");
    ...
    public function editCurrency($currency_id, $data) {
        ...
        decimal_place = '" . $this->db->escape($data['decimal_place']) . "', value = '" . $this->db->escape($data['value']) . "',
        nominal = '" . $this->db->escape($data['nominal']) . "',
        value_official = '" . $this->db->escape($data['value_official']) . "', status = '" . (int)$data['status'] . "',
