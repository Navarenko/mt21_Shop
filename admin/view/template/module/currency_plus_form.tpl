            ...
            <div class="panel-body">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-currency" class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="value" value="<?php echo $value; ?>" placeholder="<?php echo $entry_value; ?>" id="input-value" class="form-control" onchange="$('#input-value-official').val(1/this.value);"/>
                        </div>
                    </div>


                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-nominal"><?php echo $entry_nominal; ?></label>
                        <div class="col-sm-10">
                            <input type="text" name="nominal" value="<?php echo $nominal; ?>" placeholder="<?php echo $entry_nominal; ?>" id="input-nominal" class="form-control"/>
                        </div>
                    </div>

                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-value-official"><?php echo $entry_value_official; ?></label>
                        <div class="col-sm-10">
                            <input type="text" name="value_official" value="<?php echo $value_official; ?>" placeholder="<?php echo $entry_value_official; ?>" id="input-value-official" class="form-control" onchange="$('#input-value').val(1/this.value*$('#input-nominal').val());" />
                        </div>
                    </div>
