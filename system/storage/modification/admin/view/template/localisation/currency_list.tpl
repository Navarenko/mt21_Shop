...
<div id="content">
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right"><a href="<?php echo $refresh; ?>" data-toggle="tooltip" title="<?php echo $button_currency; ?>" class="btn btn-warning"><i class="fa fa fa-refresh"></i></a> 
                <a href="index.php?route=module/currency_plus&token=<?php echo $token; ?>" data-toggle="tooltip" title="<?php echo $button_settings; ?>" class="btn btn-info"><i class="fa fa-edit"></i></a>
                <a href="<?php echo $add; ?>"
             data-toggle="tooltip" title="<?php echo $button_add; ?>" class="btn btn-primary"><i class="fa fa-plus"></i></a>
