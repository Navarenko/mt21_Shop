...
class ControllerCatalogProduct extends Controller {
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
		        ...
		        $this->load->model('module/currency_plus');
                $this->model_module_currency_plus->create_fields();
			...
			if (isset($this->request->get['page'])) {
		        ...
		        if (file_exists(DIR_APPLICATION.'/controller/editors/product.php')) {
                    $this->response->redirect($this->url->link('editors/product', 'token=' . $this->session->data['token'] . $url, 'SSL'));
                }
                else {
	...
	protected function getList() {
		...
		if (isset($this->request->get['page'])) {
			$url .= '&page=' . $this->request->get['page'];
		        ...
		        if (file_exists(DIR_APPLICATION.'/controller/editors/product.php')) {
                    $href_edit = 'editors/product';
                }
                else {
                    $href_edit = 'catalog/product';
                }
		...
		$data['breadcrumbs'][] = array(
			'text' => $this->language->get('heading_title'),
		        ...
		        'href' => $this->url->link($href_edit, 'token=' . $this->session->data['token'] . $url, 'SSL')
		...
		$data['entry_model'] = $this->language->get('entry_model');
                ...
                $data['entry_extra_charge'] = $this->language->get('entry_extra_charge');
	...
	protected function getForm() {
		...
		if (!isset($this->request->get['product_id'])) {
			...
			$data['action'] = $this->url->link('catalog/product/edit', 'token=' . $this->session->data['token'] . '&product_id=' . $this->request->get['product_id'] . $url, 'SSL');
		        ...
		        if (file_exists(DIR_APPLICATION.'/controller/editors/product.php')) {
                    $data['cancel'] = $this->url->link('editors/product', 'token=' . $this->session->data['token'] . $url, 'SSL');
                }
                else {
		...
		if (isset($this->request->post['stock_status_id'])) {
			...
			$data['stock_status_id'] = 0;
                ...
                if (isset($this->request->post['extra_charge'])) {
                    $data['extra_charge'] = $this->request->post['extra_charge'];
                } else if (isset($product_info['extra_charge'])) {
                    $data['extra_charge'] = $product_info['extra_charge'];
                } else {
                    $data['extra_charge'] = '';
                }
		...
		foreach ($product_discounts as $product_discount) {
			$data['product_discounts'][] = array(
                ...
                'base_price' => isset($product_discount['base_price'])? $product_discount['base_price'] : '',
		...
		foreach ($product_specials as $product_special) {
			$data['product_specials'][] = array(
                ...
                'base_price' => isset($product_special['base_price'])? $product_special['base_price'] : '',
