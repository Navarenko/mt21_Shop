...
$product_total = $this->model_catalog_search_mr->getTotalProducts($filter_data);
...
$product_total = $this->model_catalog_search_mr->getTotalProducts($filter_data);
			...
			foreach ($results as $result) {
				...
				if (($this->config->get('config_customer_price') && $this->customer->isLogged()) || !$this->config->get('config_customer_price')) {
					$price = $this->currency->format($this->tax->calculate($result['price'], $result['tax_class_id'], $this->config->get('config_tax')), 0, 0, 1, 0); //for round price in my place
				} else {
					$price = false;
				}
                ...
                'base_price'          => (isset($result['base_price']) and $result['base_price'] > 0 ) ? $this->currency->format(1, $result['base_currency_code'], $result['base_price'], true) : '',
				'int_base_price'          => (isset($result['base_price']) and $result['base_price'] > 0 ) ? $result['base_price'] : '',
                'base_special'        => (isset($result['base_special']) and $result['base_special'] > 0 ) ? $this->currency->format(1, $result['base_currency_code'], $result['base_special'], true) : '',
