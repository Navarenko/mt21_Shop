...
<div class="container">
 <div class="row"><?php echo $column_left; ?>
	...
	<div class="row">
      ...
      <br />
      <div id="btn-click" class="row filtr-container">
          ...
          <div class="product-thumb">
			...
			<div class="category_block_btn-group">
              <div class="btn-group">
				...
				<button type="button" class="btn btn-default btn-7 btn-7h" onclick="addQtyToCart('<?php echo $product['product_id']; ?>');"><?php echo $button_cart; ?></button>
