<?php
// == MOD == закомменчено convert_encoding. 
// Функция convert_encoding не работает почему-то (ipad не примнимает её результат), а новый json_encode с параметром, который сам должен кодировать UTF напрямую, работает только в PHP 5.4
/**
 * @file
