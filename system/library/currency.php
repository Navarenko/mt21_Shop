...
class Currency {
	...
	public function format($number, $currency = '', $value = '', $format = true, $hard_decimal_place = -1) {
		...
		if ($hard_decimal_place >= 0) { //for round price in my place
			$decimal_place = $hard_decimal_place;
		}
