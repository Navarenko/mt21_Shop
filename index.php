...
require_once(DIR_SYSTEM . 'library/mshpo.php');
require_once(DIR_SYSTEM . 'library/encoding/encoding.php');
...
// Mshpo - для мобильного приложения
$mshpo = new Mshpo($registry);
$registry->set('mshpo', $mshpo);
